...
# =============================
# LOGIN ESTILIZADO - DESIGN AZUL COM ILUSTRACAO
# =============================
def tela_login():
    # CSS Personalizado
    st.markdown("""
    ...
    with col1:
        # Painel azul com gradiente
        painel_html = """
        <div style='background: linear-gradient(180deg, #00B4DB 0%, #0083B0 100%);
                    height: 100vh;
                    display: flex;
    ...
    # ========== COLUNA DIREITA - ILUSTRACAO ==========
    with col2:
        ilustracao_html = """
        <div style='height: 100vh; display: flex; justify-content: center; align-items: center; background: white; position: relative; overflow: hidden;'>
        ...
        """
        st.markdown(ilustracao_html, unsafe_allow_html=True)
